...
try {
    ...
    console.log("🌍 Connected to the Sasaki Database")
} catch {
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/Alp24ni/SASAKI-MD')
	}
    }
    main()
    //========================================================================================================================================
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            try {
                                ...
                                ppurl = 'https://telegra.ph/file/3acc05e0bca7f81ec7605.jpg'
                            }
                            let buttonMessage = {
                                image: {url : ppUrl },
